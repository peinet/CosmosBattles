...
#pragma warning disable 0162 // Unreachable code detected
        ...
        */
        protected internal virtual void Closure(ATNConfigSet sourceConfigs, ATNConfigSet configs, bool collectPredicates, bool hasMoreContext, PredictionContextCache contextCache, bool treatEofAsEpsilon)
        {
            ...
            AntlrHashSet<ATNConfig> closureBusy = new AntlrHashSet<ATNConfig>();
        ...
        protected internal virtual void Closure(ATNConfig config, ATNConfigSet configs, ATNConfigSet intermediate, AntlrHashSet<ATNConfig> closureBusy, bool collectPredicates, bool hasMoreContexts, PredictionContextCache contextCache, int depth, bool treatEofAsEpsilon)
        {
            if (config.State is RuleStopState)
            {
