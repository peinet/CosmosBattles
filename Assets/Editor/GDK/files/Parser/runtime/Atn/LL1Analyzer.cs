    ...
    public class LL1Analyzer
    {
        ...
        public virtual IntervalSet[] GetDecisionLookahead(ATNState s)
        {
            ...
            for (int alt = 0; alt < s.NumberOfTransitions; alt++)
            {
                ...
                AntlrHashSet<ATNConfig> lookBusy = new AntlrHashSet<ATNConfig>();
        ...
        public virtual IntervalSet Look(ATNState s, ATNState stopState, PredictionContext ctx)
        {
            ...
            bool addEOF = true;
            Look(s, stopState, ctx, r, new AntlrHashSet<ATNConfig>(), new BitSet(), seeThruPreds, addEOF);
            return r;
        }
        ...
        /// <c>new AntlrHashSet&lt;ATNConfig&gt;</c>
        /// for this argument.
        /// </param>
        ...
        /// .
        /// </param>
        protected internal virtual void Look(ATNState s, ATNState stopState, PredictionContext ctx, IntervalSet look, AntlrHashSet<ATNConfig> lookBusy, BitSet calledRuleStack, bool seeThruPreds, bool addEOF)
        {
